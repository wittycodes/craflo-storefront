...
exports.UrlInputEditor = void 0;
var ko = require("knockout");
var urlInputEditor_html_1 = require("./urlInputEditor.html");
var styles_1 = require("@paperbits/styles");
var urlInputModel_1 = require("../urlInputModel");
var decorators_1 = require("@paperbits/common/ko/decorators");
var UrlInputEditor = (function () {
    function UrlInputEditor(styleService) {
    ...
    UrlInputEditor.prototype.initialize = function () {
        var _a;
    ...
    UrlInputEditor.prototype.applyChanges = function () {
    ...
    __decorate([
        decorators_1.Param(),
        __metadata("design:type", urlInputModel_1.UrlInputModel)
    ], UrlInputEditor.prototype, "model", void 0);
    __decorate([
        decorators_1.Event(),
        __metadata("design:type", Function)
    ], UrlInputEditor.prototype, "onChange", void 0);
    __decorate([
        decorators_1.OnMounted(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], UrlInputEditor.prototype, "initialize", null);
    UrlInputEditor = __decorate([
        decorators_1.Component({
            selector: "url-input-editor",
            template: urlInputEditor_html_1.default
        }),
        __metadata("design:paramtypes", [styles_1.StyleService])
    ], UrlInputEditor);
    return UrlInputEditor;
}());
exports.UrlInputEditor = UrlInputEditor;
