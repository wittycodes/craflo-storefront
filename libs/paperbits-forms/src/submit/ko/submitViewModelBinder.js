...
exports.SubmitViewModelBinder = void 0;
var submit_1 = require("./submit");
var submitModel_1 = require("../submitModel");
var SubmitViewModelBinder = (function () {
    function SubmitViewModelBinder(eventManager, styleCompiler) {
        this.eventManager = eventManager;
        this.styleCompiler = styleCompiler;
    }
    SubmitViewModelBinder.prototype.modelToViewModel = function (model, viewModel, bindingContext) {
    ...
    SubmitViewModelBinder.prototype.canHandleModel = function (model) {
        return model instanceof submitModel_1.SubmitModel;
    };
    return SubmitViewModelBinder;
}());
exports.SubmitViewModelBinder = SubmitViewModelBinder;
