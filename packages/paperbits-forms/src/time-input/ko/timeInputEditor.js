...
exports.TimeInputEditor = void 0;
var ko = require("knockout");
var timeInputEditor_html_1 = require("./timeInputEditor.html");
var styles_1 = require("@paperbits/styles");
var timeInputModel_1 = require("../timeInputModel");
var decorators_1 = require("@paperbits/common/ko/decorators");
var TimeInputEditor = (function () {
    function TimeInputEditor(styleService) {
    ...
    TimeInputEditor.prototype.initialize = function () {
        var _a;
    ...
    TimeInputEditor.prototype.applyChanges = function () {
    ...
    __decorate([
        decorators_1.Param(),
        __metadata("design:type", timeInputModel_1.TimeInputModel)
    ], TimeInputEditor.prototype, "model", void 0);
    __decorate([
        decorators_1.Event(),
        __metadata("design:type", Function)
    ], TimeInputEditor.prototype, "onChange", void 0);
    __decorate([
        decorators_1.OnMounted(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], TimeInputEditor.prototype, "initialize", null);
    TimeInputEditor = __decorate([
        decorators_1.Component({
            selector: "time-input-editor",
            template: timeInputEditor_html_1.default
        }),
        __metadata("design:paramtypes", [styles_1.StyleService])
    ], TimeInputEditor);
    return TimeInputEditor;
}());
exports.TimeInputEditor = TimeInputEditor;
