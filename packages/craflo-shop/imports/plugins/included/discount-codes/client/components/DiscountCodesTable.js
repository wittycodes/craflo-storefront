...
// import ButtonPB from 'imports/client/ui/pb/components/Button'
  ...
  return (
    <>
      <Card className={classes.card}>
        ...
        {/*</Box>*/}
        <CardContent>
          <Button style={{marginTop: '20px', marginLeft: '8px'}} variant="contained" color="primary"  onClick={onCreateDiscountCode} >
            {"Add New Coupon"}
          </Button>
