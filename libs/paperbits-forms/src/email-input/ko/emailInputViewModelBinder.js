...
exports.EmailInputViewModelBinder = void 0;
var emailInput_1 = require("./emailInput");
var emailInputModel_1 = require("../emailInputModel");
var EmailInputViewModelBinder = (function () {
    function EmailInputViewModelBinder(eventManager, styleCompiler) {
        this.eventManager = eventManager;
        this.styleCompiler = styleCompiler;
    }
    EmailInputViewModelBinder.prototype.modelToViewModel = function (model, viewModel, bindingContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!viewModel) {
                            viewModel = new emailInput_1.EmailInput();
                        }
    ...
    EmailInputViewModelBinder.prototype.canHandleModel = function (model) {
        return model instanceof emailInputModel_1.EmailInputModel;
    };
    return EmailInputViewModelBinder;
}());
exports.EmailInputViewModelBinder = EmailInputViewModelBinder;
