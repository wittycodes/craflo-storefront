...
exports.MultilineInputViewModelBinder = void 0;
var multilineInput_1 = require("./multilineInput");
var multilineInputModel_1 = require("../multilineInputModel");
var MultilineInputViewModelBinder = (function () {
    function MultilineInputViewModelBinder(eventManager, styleCompiler) {
        this.eventManager = eventManager;
        this.styleCompiler = styleCompiler;
    }
    MultilineInputViewModelBinder.prototype.modelToViewModel = function (model, viewModel, bindingContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!viewModel) {
                            viewModel = new multilineInput_1.MultilineInput();
                        }
    ...
    MultilineInputViewModelBinder.prototype.canHandleModel = function (model) {
        return model instanceof multilineInputModel_1.MultilineInputModel;
    };
    return MultilineInputViewModelBinder;
}());
exports.MultilineInputViewModelBinder = MultilineInputViewModelBinder;
