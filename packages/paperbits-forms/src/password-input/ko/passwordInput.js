...
var passwordInput_html_1 = require("./passwordInput.html");
var decorators_1 = require("@paperbits/common/ko/decorators");
var PasswordInput = (function () {
    function PasswordInput() {
        this.label = ko.observable("Password input");
        this.name = ko.observable();
        this.value = ko.observable();
        this.placeholder = ko.observable("Password input");
    ...
    PasswordInput = __decorate([
        decorators_1.Component({
            ...
            template: passwordInput_html_1.default
        }),
