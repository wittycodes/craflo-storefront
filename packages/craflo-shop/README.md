# Craflo Shop
one stop destination for creative artists for management of thier shop.
- shop profiles
- kyc
- orders
- products
...
Implemented in Meteor js, via publishing & subscriptions from database directly. And, some usage of graphql craflo-api 
