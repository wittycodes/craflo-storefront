...
var ColumnViewModelBinder = (function () {
    function ColumnViewModelBinder(viewModelBinderSelector, eventManager, styleCompiler) {
        this.viewModelBinderSelector = viewModelBinderSelector;
        this.eventManager = eventManager;
        this.styleCompiler = styleCompiler;
    }
    ColumnViewModelBinder.prototype.modelToViewModel = function (model, viewModel, bindingContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!viewModel) {
                            viewModel = new columnViewModel_1.ColumnViewModel();
                        }
                        viewModels = [];
                    ...
                    case 4:
                        if (viewModels.length === 0) {
                            viewModels.push(new ko_1.PlaceholderViewModel("Column"));
                        }
                        ...
                        binding = {
                            ...
                            applyChanges: function (changes) { return __awaiter(_this, void 0, void 0, function () {
    ...
    ColumnViewModelBinder.prototype.canHandleModel = function (model) {
        return model instanceof columnModel_1.ColumnModel;
    };
    return ColumnViewModelBinder;
}());
