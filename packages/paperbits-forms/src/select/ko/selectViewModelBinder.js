...
exports.SelectViewModelBinder = void 0;
var selectInputModel_1 = require("../selectInputModel");
var selectInput_1 = require("./selectInput");
var SelectViewModelBinder = (function () {
    function SelectViewModelBinder(eventManager, styleCompiler) {
        this.eventManager = eventManager;
        this.styleCompiler = styleCompiler;
    }
    SelectViewModelBinder.prototype.modelToViewModel = function (model, viewModel, bindingContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!viewModel) {
                            viewModel = new selectInput_1.SelectInput();
                        }
    ...
    SelectViewModelBinder.prototype.canHandleModel = function (model) {
        return model instanceof selectInputModel_1.SelectInputModel;
    };
    return SelectViewModelBinder;
}());
exports.SelectViewModelBinder = SelectViewModelBinder;
