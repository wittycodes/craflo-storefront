...
var StyledBindingHandler = (function () {
    function StyledBindingHandler() {
        ...
        ko.bindingHandlers["styledInPlace"] = {
            update: function (element, valueAccessor) { return __awaiter(_this, void 0, void 0, function () {
                var styleModel, cssObservable, styleElement, compiler, css;
                return __generator(this, function (_a) {
                    styleModel = ko.unwrap(valueAccessor());
                    if (!styleModel) {
                        return [2];
                    ...
                    styleElement = element.ownerDocument.getElementById(styleModel.key);
    ...
    return StyledBindingHandler;
}());
exports.StyledBindingHandler = StyledBindingHandler;
