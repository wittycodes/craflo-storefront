...
var ColorSelector = (function () {
    ...
    ColorSelector.prototype.loadColors = function () {
        return __awaiter(this, void 0, void 0, function () {
            var themeContract, defaultColorKey, colors;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        defaultColorKey = this.initColorKey();
                        colors = Object.keys(themeContract.colors).map(function (key) {
                            ...
                            if (defaultColorKey && colorContract.key === defaultColorKey) {
                                _this.selectedColor(colorContract);
                            }
    ...
    ColorSelector.prototype.clearColors = function () {
        if (this.selectedColor) {
    ...
    ], ColorSelector.prototype, "initColorKey", void 0);
    __decorate([
        decorators_1.Param(),
        __metadata("design:type", Function)
    ], ColorSelector.prototype, "selectedColor", void 0);
    __decorate([
        decorators_1.Event(),
        __metadata("design:type", Function)
    ], ColorSelector.prototype, "onSelect", void 0);
    __decorate([
        decorators_1.OnMounted(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], ColorSelector.prototype, "loadColors", null);
    ColorSelector = __decorate([
        decorators_1.Component({
            selector: "color-selector",
            template: colorSelector_html_1.default
        }),
