...
exports.LayoutsWorkshop = void 0;
const ko = require("knockout");
const layouts_html_1 = require("./layouts.html");
...
let LayoutsWorkshop = class LayoutsWorkshop {
    ...
    addLayout() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const layout = yield this.layoutService.createLayout("New Layout", "", layoutUrlTemplate);
            const layoutItem = new layoutItem_1.LayoutItem(layout);
...
], LayoutsWorkshop.prototype, "initialize", null);
LayoutsWorkshop = __decorate([
    decorators_1.Component({
        selector: "layouts",
        template: layouts_html_1.default
    }),
