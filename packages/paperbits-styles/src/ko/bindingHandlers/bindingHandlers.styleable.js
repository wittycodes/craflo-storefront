...
exports.StylableBindingHandler = void 0;
var ko = require("knockout");
var StylableBindingHandler = (function () {
    function StylableBindingHandler(styleService) {
        var _this = this;
        this.styleService = styleService;
        ko.bindingHandlers["styleable"] = {
            update: function (element, valueAccessor) { return __awaiter(_this, void 0, void 0, function () {
                var config, style, backgroundObservable, mode, toggleBackground, styleable;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            backgroundObservable = ko.observable();
                            mode = 1;
    ...
    return StylableBindingHandler;
}());
exports.StylableBindingHandler = StylableBindingHandler;
