...
var dateInput_html_1 = require("./dateInput.html");
var decorators_1 = require("@paperbits/common/ko/decorators");
var DateInput = (function () {
    function DateInput() {
        this.label = ko.observable("Date input");
        this.name = ko.observable();
        this.value = ko.observable();
        this.placeholder = ko.observable("Date input");
    ...
    DateInput = __decorate([
        decorators_1.Component({
            selector: "date-input",
            template: dateInput_html_1.default
        }),
