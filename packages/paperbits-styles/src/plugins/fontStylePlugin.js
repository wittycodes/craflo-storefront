...
exports.FontsStylePlugin = void 0;
var styles_1 = require("@paperbits/common/styles");
var FontsStylePlugin = (function () {
    function FontsStylePlugin(permalinkResolver, themeContract) {
        this.permalinkResolver = permalinkResolver;
        this.themeContract = themeContract;
        this.displayName = "Font";
    }
    FontsStylePlugin.prototype.contractToFontFaces = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fontFaces, _i, _a, fontKey, fontContract, _b, _c, variant, fontVariantUrl, fontFace;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _i = 0, _a = Object.keys(this.themeContract.fonts);
                        _d.label = 1;
                    case 1:
                        if (!(_i < _a.length)) return [3, 8];
                        fontKey = _a[_i];
                        fontContract = this.themeContract.fonts[fontKey];
                        if (!fontContract.variants) {
                            return [3, 7];
                        }
                        _b = 0, _c = fontContract.variants;
                        _d.label = 2;
                    case 2:
                        if (!(_b < _c.length)) return [3, 7];
                        variant = _c[_b];
                        fontVariantUrl = void 0;
                        if (!variant.sourceKey) return [3, 4];
                        return [4, this.permalinkResolver.getUrlByTargetKey(variant.sourceKey)];
                    case 3:
                        fontVariantUrl = _d.sent();
                        return [3, 5];
                    case 4:
                        if (variant.file || variant.permalink) {
                    ...
                    case 7:
                        _i++;
                        return [3, 1];
                    case 8: return [2, fontFaces];
                }
            });
        });
    };
    return FontsStylePlugin;
}());
exports.FontsStylePlugin = FontsStylePlugin;
