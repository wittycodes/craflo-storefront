...
var FirebaseBlobStorage = (function () {
                ...
                return [2, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    storageRef = _a.sent();
                                    return [4, storageRef.file(name).save(Buffer.from(content.buffer), {
                                            metadata: {
    ...
    FirebaseBlobStorage.prototype.getDownloadUrl = function (blobKey) {
        return __awaiter(this, void 0, void 0, function () {
            var storageRef, key, file, downloadUrls;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.firebaseService.getStorageRef()];
                    case 1:
                        storageRef = _a.sent();
                        key = this.firebaseService.storageBasePath;
                        if (key.endsWith("/")) {
                        ...
                        file = storageRef.file(key);
                        return [4, file.getSignedUrl({ action: "read", expires: "01-01-2100" })];
                    case 2:
                        downloadUrls = _a.sent();
                        if (downloadUrls.length > 0) {
                            return [2, downloadUrls[0]];
                        }
                        return [2, null];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        storageRef = _a.sent();
                        return [4, storageRef.file(filename).delete()];
                    case 2:
                        _a.sent();
                        return [2];
                }
