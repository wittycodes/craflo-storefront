...
exports.PasswordInputEditor = void 0;
var ko = require("knockout");
var passwordInputEditor_html_1 = require("./passwordInputEditor.html");
var styles_1 = require("@paperbits/styles");
var passwordInputModel_1 = require("../passwordInputModel");
var decorators_1 = require("@paperbits/common/ko/decorators");
var PasswordInputEditor = (function () {
    function PasswordInputEditor(styleService) {
    ...
    PasswordInputEditor.prototype.initialize = function () {
        var _a;
    ...
    PasswordInputEditor.prototype.applyChanges = function () {
    ...
    __decorate([
        decorators_1.Param(),
        __metadata("design:type", passwordInputModel_1.PasswordInputModel)
    ], PasswordInputEditor.prototype, "model", void 0);
    __decorate([
        decorators_1.Event(),
        __metadata("design:type", Function)
    ], PasswordInputEditor.prototype, "onChange", void 0);
    __decorate([
        decorators_1.OnMounted(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], PasswordInputEditor.prototype, "initialize", null);
    PasswordInputEditor = __decorate([
        decorators_1.Component({
            selector: "password-input-editor",
            template: passwordInputEditor_html_1.default
        }),
        __metadata("design:paramtypes", [styles_1.StyleService])
    ], PasswordInputEditor);
    return PasswordInputEditor;
}());
exports.PasswordInputEditor = PasswordInputEditor;
