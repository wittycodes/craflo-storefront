...
exports.EmailInputEditor = void 0;
var ko = require("knockout");
var emailInputEditor_html_1 = require("./emailInputEditor.html");
var styles_1 = require("@paperbits/styles");
var emailInputModel_1 = require("../emailInputModel");
var decorators_1 = require("@paperbits/common/ko/decorators");
var EmailInputEditor = (function () {
    function EmailInputEditor(styleService) {
    ...
    EmailInputEditor.prototype.initialize = function () {
        var _a;
    ...
    EmailInputEditor.prototype.applyChanges = function () {
    ...
    __decorate([
        decorators_1.Param(),
        __metadata("design:type", emailInputModel_1.EmailInputModel)
    ], EmailInputEditor.prototype, "model", void 0);
    __decorate([
        decorators_1.Event(),
        __metadata("design:type", Function)
    ], EmailInputEditor.prototype, "onChange", void 0);
    __decorate([
        decorators_1.OnMounted(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], EmailInputEditor.prototype, "initialize", null);
    EmailInputEditor = __decorate([
        decorators_1.Component({
            selector: "email-input-editor",
            template: emailInputEditor_html_1.default
        }),
        __metadata("design:paramtypes", [styles_1.StyleService])
    ], EmailInputEditor);
    return EmailInputEditor;
}());
exports.EmailInputEditor = EmailInputEditor;
