...
exports.TimeInputViewModelBinder = void 0;
var timeInput_1 = require("./timeInput");
var timeInputModel_1 = require("../timeInputModel");
var TimeInputViewModelBinder = (function () {
    function TimeInputViewModelBinder(eventManager, styleCompiler) {
        this.eventManager = eventManager;
        this.styleCompiler = styleCompiler;
    }
    TimeInputViewModelBinder.prototype.modelToViewModel = function (model, viewModel, bindingContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!viewModel) {
                            viewModel = new timeInput_1.TimeInput();
                        }
    ...
    TimeInputViewModelBinder.prototype.canHandleModel = function (model) {
        return model instanceof timeInputModel_1.TimeInputModel;
    };
    return TimeInputViewModelBinder;
}());
exports.TimeInputViewModelBinder = TimeInputViewModelBinder;
