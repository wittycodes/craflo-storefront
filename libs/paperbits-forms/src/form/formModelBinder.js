...
exports.FormModelBinder = void 0;
var formModel_1 = require("./formModel");
var FormModelBinder = (function () {
    function FormModelBinder(modelBinderSelector) {
        this.modelBinderSelector = modelBinderSelector;
    }
    FormModelBinder.prototype.canHandleContract = function (contract) {
        return contract.type === "form";
    };
    FormModelBinder.prototype.canHandleModel = function (model) {
        return model instanceof formModel_1.FormModel;
    };
    FormModelBinder.prototype.contractToModel = function (node, bindingContext) {
        return __awaiter(this, void 0, void 0, function () {
            var model, modelPromises, _a;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        model = new formModel_1.FormModel();
                        model.formAction = node.formAction;
                        model.formMethod = node.formMethod;
                        model.formTarget = node.formTarget;
                        model.acceptCharset = node.acceptCharset;
                        model.encType = node.encType;
                        ...
                        if (!node.nodes) return [3, 2];
                        modelPromises = node.nodes.map(function (contract) { return __awaiter(_this, void 0, void 0, function () {
                            var modelBinder;
                    ...
                    case 2:
                        model.widgets = [];
                        _b.label = 3;
                    case 3: return [2, model];
                }
            });
        });
    };
    FormModelBinder.prototype.modelToContract = function (model) {
        var _this = this;
        var contract = {
            type: "form",
        ...
        model.widgets.forEach(function (widgetModel) {
