...
exports.MultilineInputEditor = void 0;
var ko = require("knockout");
var multilineInputEditor_html_1 = require("./multilineInputEditor.html");
var styles_1 = require("@paperbits/styles");
var multilineInputModel_1 = require("../multilineInputModel");
var decorators_1 = require("@paperbits/common/ko/decorators");
var MultilineInputEditor = (function () {
    function MultilineInputEditor(styleService) {
    ...
    MultilineInputEditor.prototype.initialize = function () {
        var _a;
    ...
    MultilineInputEditor.prototype.applyChanges = function () {
    ...
    __decorate([
        decorators_1.Param(),
        __metadata("design:type", multilineInputModel_1.MultilineInputModel)
    ], MultilineInputEditor.prototype, "model", void 0);
    __decorate([
        decorators_1.Event(),
        __metadata("design:type", Function)
    ], MultilineInputEditor.prototype, "onChange", void 0);
    __decorate([
        decorators_1.OnMounted(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], MultilineInputEditor.prototype, "initialize", null);
    MultilineInputEditor = __decorate([
        decorators_1.Component({
            selector: "multiline-input-editor",
            template: multilineInputEditor_html_1.default
        }),
        __metadata("design:paramtypes", [styles_1.StyleService])
    ], MultilineInputEditor);
    return MultilineInputEditor;
}());
exports.MultilineInputEditor = MultilineInputEditor;
