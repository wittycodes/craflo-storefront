...
exports.RangeInputEditor = void 0;
var ko = require("knockout");
var rangeInputEditor_html_1 = require("./rangeInputEditor.html");
var styles_1 = require("@paperbits/styles");
var rangeInputModel_1 = require("../rangeInputModel");
var decorators_1 = require("@paperbits/common/ko/decorators");
var RangeInputEditor = (function () {
    function RangeInputEditor(styleService) {
    ...
    RangeInputEditor.prototype.initialize = function () {
        var _a;
    ...
    RangeInputEditor.prototype.applyChanges = function () {
    ...
    __decorate([
        decorators_1.Param(),
        __metadata("design:type", rangeInputModel_1.RangeInputModel)
    ], RangeInputEditor.prototype, "model", void 0);
    __decorate([
        decorators_1.Event(),
        __metadata("design:type", Function)
    ], RangeInputEditor.prototype, "onChange", void 0);
    __decorate([
        decorators_1.OnMounted(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], RangeInputEditor.prototype, "initialize", null);
    RangeInputEditor = __decorate([
        decorators_1.Component({
            selector: "range-input-editor",
            template: rangeInputEditor_html_1.default
        }),
        __metadata("design:paramtypes", [styles_1.StyleService])
    ], RangeInputEditor);
    return RangeInputEditor;
}());
exports.RangeInputEditor = RangeInputEditor;
