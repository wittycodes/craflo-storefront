...
var SectionModelBinder = (function () {
    function SectionModelBinder(modelBinderSelector) {
        this.modelBinderSelector = modelBinderSelector;
    }
    SectionModelBinder.prototype.canHandleContract = function (contract) {
        return contract.type === "email-layout-section";
    };
    SectionModelBinder.prototype.canHandleModel = function (model) {
        return model instanceof sectionModel_1.SectionModel;
    };
    SectionModelBinder.prototype.contractToModel = function (contract, bindingContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        model = new sectionModel_1.SectionModel();
    ...
    SectionModelBinder.prototype.modelToContract = function (sectionModel) {
        var _this = this;
        var sectionContract = {
        ...
        sectionModel.widgets.forEach(function (widgetModel) {
