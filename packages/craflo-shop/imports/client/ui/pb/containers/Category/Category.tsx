...
// import TagFormPage from "imports/plugins/core/tags/client/pages/TagFormPageWithData";
import TagSettingsPage from "imports/plugins/core/tags/client/pages/TagSettingsPageWithData";
//
...
export default function Category() {
  ...
  const updateDrawer = useCallback(
    () => dispatch({ type: 'OPEN_DRAWER', drawerComponent: 'CATEGORY_UPDATE_FORM' }),
    [dispatch]
  );
  ...
  return (
    <Grid fluid={true}>
      <TagSettingsPage createD={createDrawer} updateD={updateDrawer}/>
      {/*<Row>*/}
      {/*  <Col md={12}>*/}
      {/*    <Header*/}
      {/*      style={{*/}
