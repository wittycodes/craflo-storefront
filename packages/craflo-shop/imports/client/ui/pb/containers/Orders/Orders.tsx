...
import ROrders from "/imports/plugins/core/orders/client/components/OrdersTable";

// import OrderPrint from "/imports/plugins/core/orders/client/containers/OrderPrintContainer";
...
export default function Orders() {
  ...
  const openDrawer = useCallback(
    () => dispatch({ type: 'OPEN_DRAWER', drawerComponent: 'ORDER_DETAILS' }),
    [dispatch]
  );
  ...
  return (
    <Grid fluid={true}>
      <Row>
        <Col md={12}>
          <ROrders orderHandler={openDrawer}/>
        {/*  <Header*/}
        {/*    style={{*/}
        {/*      marginBottom: 30,*/}
