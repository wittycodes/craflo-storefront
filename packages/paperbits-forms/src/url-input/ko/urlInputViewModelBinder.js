...
exports.UrlInputViewModelBinder = void 0;
var urlInput_1 = require("./urlInput");
var urlInputModel_1 = require("../urlInputModel");
var UrlInputViewModelBinder = (function () {
    function UrlInputViewModelBinder(eventManager, styleCompiler) {
        this.eventManager = eventManager;
        this.styleCompiler = styleCompiler;
    }
    UrlInputViewModelBinder.prototype.modelToViewModel = function (model, viewModel, bindingContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!viewModel) {
                            viewModel = new urlInput_1.UrlInput();
                        }
    ...
    UrlInputViewModelBinder.prototype.canHandleModel = function (model) {
        return model instanceof urlInputModel_1.UrlInputModel;
    };
    return UrlInputViewModelBinder;
}());
exports.UrlInputViewModelBinder = UrlInputViewModelBinder;
