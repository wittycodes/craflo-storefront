...
exports.NumberInputViewModelBinder = void 0;
var numberInput_1 = require("./numberInput");
var numberInputModel_1 = require("../numberInputModel");
var NumberInputViewModelBinder = (function () {
    function NumberInputViewModelBinder(eventManager, styleCompiler) {
        this.eventManager = eventManager;
        this.styleCompiler = styleCompiler;
    }
    NumberInputViewModelBinder.prototype.modelToViewModel = function (model, viewModel, bindingContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!viewModel) {
                            viewModel = new numberInput_1.NumberInput();
                        }
    ...
    NumberInputViewModelBinder.prototype.canHandleModel = function (model) {
        return model instanceof numberInputModel_1.NumberInputModel;
    };
    return NumberInputViewModelBinder;
}());
exports.NumberInputViewModelBinder = NumberInputViewModelBinder;
