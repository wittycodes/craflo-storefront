...
var numberInput_html_1 = require("./numberInput.html");
var decorators_1 = require("@paperbits/common/ko/decorators");
var NumberInput = (function () {
    function NumberInput() {
        this.label = ko.observable("Number input");
        this.name = ko.observable();
        this.value = ko.observable();
        this.placeholder = ko.observable("Number input");
    ...
    NumberInput = __decorate([
        decorators_1.Component({
            ...
            template: numberInput_html_1.default
        }),
