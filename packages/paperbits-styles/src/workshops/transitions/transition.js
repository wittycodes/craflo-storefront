...
var transition_html_1 = require("./transition.html");
...
var Transition = (function () {
    function Transition(styleService) {
        var _this = this;
        this.styleService = styleService;
        this.timingFunctionOptions = [
        ...
        this.enabled = ko.computed(function () { return _this.timingFunction() && _this.timingFunction() !== "none"; });
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.fillout(transitions)];
                    case 1:
                        _a.sent();
    ...
    Transition.prototype.fillout = function (transitionsConfig) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    Transition.prototype.applyChanges = function () {
        if (this.onUpdate) {
            this.onUpdate({
                delay: this.delay(),
    ...
    ], Transition.prototype, "transition", void 0);
    __decorate([
        decorators_1.Event(),
        __metadata("design:type", Function)
    ], Transition.prototype, "onUpdate", void 0);
    __decorate([
        decorators_1.OnMounted(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], Transition.prototype, "initialize", null);
    Transition = __decorate([
        decorators_1.Component({
            selector: "transition",
            template: transition_html_1.default
        }),
