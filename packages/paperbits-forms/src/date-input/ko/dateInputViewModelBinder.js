...
exports.DateInputViewModelBinder = void 0;
var dateInput_1 = require("./dateInput");
var dateInputModel_1 = require("../dateInputModel");
var DateInputViewModelBinder = (function () {
    function DateInputViewModelBinder(eventManager, styleCompiler) {
        this.eventManager = eventManager;
        this.styleCompiler = styleCompiler;
    }
    DateInputViewModelBinder.prototype.modelToViewModel = function (model, viewModel, bindingContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!viewModel) {
                            viewModel = new dateInput_1.DateInput();
                        }
    ...
    DateInputViewModelBinder.prototype.canHandleModel = function (model) {
        return model instanceof dateInputModel_1.DateInputModel;
    };
    return DateInputViewModelBinder;
}());
exports.DateInputViewModelBinder = DateInputViewModelBinder;
