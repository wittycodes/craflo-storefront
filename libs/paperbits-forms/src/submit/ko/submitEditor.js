...
exports.SubmitEditor = void 0;
var ko = require("knockout");
var submitEditor_html_1 = require("./submitEditor.html");
...
var SubmitEditor = (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4, this.styleService.getComponentVariations("button")];
                    case 1:
                        variations = _b.sent();
    ...
    SubmitEditor.prototype.applyChanges = function () {
    ...
    __decorate([
        decorators_1.Param(),
        __metadata("design:type", submitModel_1.SubmitModel)
    ], SubmitEditor.prototype, "model", void 0);
    __decorate([
        decorators_1.Event(),
        __metadata("design:type", Function)
    ], SubmitEditor.prototype, "onChange", void 0);
    __decorate([
        decorators_1.OnMounted(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], SubmitEditor.prototype, "initialize", null);
    SubmitEditor = __decorate([
        decorators_1.Component({
            selector: "submit-editor",
            template: submitEditor_html_1.default
        }),
        __metadata("design:paramtypes", [styles_1.StyleService])
    ], SubmitEditor);
    return SubmitEditor;
}());
exports.SubmitEditor = SubmitEditor;
